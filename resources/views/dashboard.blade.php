        ...
        <div class="masonry-item w-100">
            <div class="row gap-20">
                <div class="col-md-3">
                    <div class="layers bd bgc-white p-20">
                        <div class="layer w-100 mB-10">
                            <h6 class="lh-1">1.Définition de votre projet</h6></div>
                ...
                <div class="col-md-3">
                    <div class="layers bd bgc-white p-20">
                        <div class="layer w-100 mB-10">
                            <h6 class="lh-1">2.Rédaction du Business Plan</h6></div>
                        <div class="layer w-100">
                            <div class="peers ai-sb fxw-nw">
                ...
                <div class="col-md-3">
                    <div class="layers bd bgc-white p-20">
                        <div class="layer w-100 mB-10">
                            <h6 class="lh-1">3.Conception du MVP</h6></div>
                        <div class="layer w-100">
                            <div class="peers ai-sb fxw-nw">
                ...
                <div class="col-md-3">
                    <div class="layers bd bgc-white p-20">
                        <div class="layer w-100 mB-10">
                            <h6 class="lh-1">4.Stratégie de lancement</h6></div>
                        <div class="layer w-100">
                            <div class="peers ai-sb fxw-nw">
