            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="mb-3">
                  ...
                  <label class="form-label" for="exampleInputEmail1" style="font-weight: 600;">Qui bénéficiera le plus de votre solution?</label>
                  <p></p>
                 </div>
              </div>
              <div class="col-lg-12">
                <div class="mb-3">
                  <label class="form-label" for="exampleInputEmail1" style="font-weight: 600;">Tranche d'age</label>
                  <p></p>
                 </div>
              </div>
            </div>
...
<br><br>
      ...
      <div class="masonry-item col-md-12">
        ...
        <form action="{{ route('p2-3.comment') }}">
            @csrf
            <div class="mb-3">
