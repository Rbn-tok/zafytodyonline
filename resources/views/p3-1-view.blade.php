            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="mb-3">
                  ...
                  <label class="form-label" for="exampleInputEmail1" style="font-weight: 600;">cadre du projet</label>
                  <p></p>
                 </div>
              </div>
              <div class="col-lg-12">
                <div class="mb-3">
                  <label class="form-label" for="exampleInputEmail1" style="font-weight: 600;">valorisation segment clientèle</label>
                  <p></p>
                 </div>
              </div>
            </div>
...
<br><br>
      ...
      <div class="masonry-item col-md-12">
        ...
        <form action="{{ route('p3-1.comment') }}">
            @csrf
            <div class="mb-3">
